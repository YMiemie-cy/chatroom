<template>
  <div id="home">
                    ...
                    <ul class="list-group list-group-flush list-unstyled p-2">
                      ...
                      <li>
                        ...
                        >
                          ...
                          <div class="ms-sm-3 d-flex">
                            <p class="small mb-2">
                              <b>Bootstrap in the news:</b>
                              The search giant’s parent company,Alphabet,just joined an exclusive
                              club of tech stocks.
                            </p>
              ...
              >
                ...
                <li>
                  <a class="dropdown-item" href="">
                    <i class="fa-fw bi bi-life-preserver me-2"></i>
                    Support
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a class="dropdown-item bg-danger-soft-hover" href="sign-in-advance.html">
    ...
    <main>
      ...
      <div class="container">
        <div class="row g-4">
                  ...
                  <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0">
                      ...
                      <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="javaScript:void(0);" @click="userInfo">
                            <img
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="javaScript:void(0);" @click="chatBox">
                            <img
                              class="me-2 h-20px fa-fw"
          ...
          <!-- Main content START -->
          <section class="content col-md-8 col-lg-6 vstack gap-4">
            <!-- Story START -->
            ...
            <div class="row g-4">
              ...
              <div class="col-sm-6 col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <!-- News item -->
                    <div class="mb-3" v-for="item in news">
                      <h6 class="mb-0">
        ...
        <div class="offcanvas-body pt-0 custom-scrollbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="mt-3 hstack gap-3 align-items-center position-relative">
              ...
              <!-- Info -->
              <div class="overflow-hidden">
                <a class="h6 mb-0 stretched-link text-truncate d-inline-block" href="#!">
                ...
                <div class="d-flex">
                  ...
                  <div class="dropdown">
                    ...
                    >
                      <li>
                        <a class="dropdown-item" href="#">
                          <i class="bi bi-camera-video me-2 fw-icon"></i>
                          Video call
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="#">
                          <i class="bi bi-telephone me-2 fw-icon"></i>
                          Audio call
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="#">
                          <i class="bi bi-trash me-2 fw-icon"></i>
                          Delete
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="#">
                          <i class="bi bi-chat-square-text me-2 fw-icon"></i>
                          Mark as unread
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="#">
                          <i class="bi bi-volume-up me-2 fw-icon"></i>
                          Muted
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="#">
                          <i class="bi bi-flag me-2 fw-icon"></i>
                          Report
                        </a>
                      </li>
                    </ul>
    ...
    <div ref="userCenter" style="display: none">
      <UserCenter @closeUserInfo="closeUserInfo" :userInformation.sync="userInformation" />
    </div>

    <div ref="chatBox" style="display: none">
      <ChatBox @closeChatBox="closeChatBox" :userInformation.sync="userInformation" />
    </div>
  </div>
</template>
...
import "../assets/js/OverlayScrollbars.min.js";
...
export default {
  ...
  methods: {
    ...
    userInfo() {
      const userCenter = this.$refs.userCenter;
...
.loveLine li:nth-child(6) {
  ...
  animation: jump4 3s 1s infinite;
}
